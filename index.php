...
<body style="background-image: url(background.png)">
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">INDIAN COURIER SERVICE</h1>
    <hr />
    <P align='center' style="font-weight: bold;font-family:'Times New Roman', Times, serif">Speed, Precision, Reliability - We Deliver It All</P>
    <div>
    ...
    <div class="container" style="margin-top: 60px; width:50%;">
        <div class="row">
            <div class="col-md-12">
                ...
                <p style="color:#800080;">Please Fill Your credentials</p>
                <!-- <?php echo $error; ?> -->
                <form action="" method="post">
                    ...
                    <p style="color: #800080;">Don't have an account?⮞➤ <a href="register.php">Register here</a>.</p>
