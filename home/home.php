...
<body style="background-image: url(back.png)">
    ...
    <div align='center' style="font-weight: bold;font-family:'Times New Roman', Times, serif"><br><br><br><br>
        <br>
    <h2>This is Indian Courier Management Service</h2>
        <h4 style="font-style: oblique;">Speed, Precision, Reliability - We Deliver It All</h4><br><br><br><br>
        <h3>DBMS MINI PROJECT</h3>
        <h6>By SURATH(167) and SUMIT(165)</h6>
    </div>
</body>
</html>