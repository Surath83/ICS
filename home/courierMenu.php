    ...
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin: auto; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center;background-color:#AFE1AF; width: 140px; height: 50px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                ...
                <tr style="text-align: center;">
                    <th colspan="2" style="background-color: #0BDA51">SENDER</th>
                    <th colspan="2" style="background-color: #2AAA8A">RECEIVER</th>
                </tr>
                <tr>
                    <td colspan="4">
                        <hr>
                ...
                <tr>
                    <br><br>
                    <td colspan="4" align="center"><input type="submit" name="submit" value="Place Order" style="margin:30px;background-color: orange;border:none; border-radius: 9px; width: 125px; height: 40px;box-shadow: 0px 0px 10px 2px grey;cursor:pointer;"></td>
                </tr>
            </table>
        </div>
    </form>
