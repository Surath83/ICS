...
<table width='80%' border="1px dash" style="text-align:center;margin-top:30px;margin-left:auto ;margin-right:auto ;border-spacing: 5px 5px;border-collapse: collapse;">
    <tr style="background-color: #90EE90;font-size:20px">
        <th>No.</th>
        <th>Item's Image</th>
        <th>Sender Name</th>
        <th>Receiver Name</th>
