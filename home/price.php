...
<body><br>
    <table width='30%' border="2px solid black" style="text-align:center;margin-top:30px;margin-left:auto ;margin-right:auto ;font-weight:bold;border-spacing: 5px 5px;border-collapse: collapse;">
    <tr style="background-color: #5F9EA0;font-size:20px">
