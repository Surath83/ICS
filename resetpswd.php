...
<body>
    ...
    <P align='center' style="font-weight: bold;color:black;font-family:'Times New Roman', Times, serif">Speed, Precision, Reliability - We Deliver It All</P>
        ...
        <div class="container" style="margin-top: 60px; width:50%;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p style="color:#800080">Reset Your Passwprd</p>
